    ...
    <div>
      ...
      <section className="relative bg-gradient-to-r from-gray-900 to-black text-white overflow-hidden">
        <div className="relative w-full h-[50vh] sm:h-[60vh] md:h-[80vh]">
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-black opacity-40" /> {/* Overlay for text readability */}
          </motion.div>
          
          {/* Text Content - Responsive positioning for mobile */}
          <div className="absolute bottom-24 sm:bottom-20 md:bottom-16 left-4 sm:left-6 md:left-8 max-w-xs sm:max-w-sm md:max-w-lg z-10">
            <motion.h1
            ...
            >
              Welcome to <span className="text-gray-300">Darul Ma'arif Valiyora</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Button
              className="bg-white text-black hover:bg-gray-200 transition-colors px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-lg font-semibold shadow-lg hover:shadow-xl border-2 border-gray-300 rounded-xl"
            >
              Read More
            </Button>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 sm:mt-4 text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
              We are committed to providing quality education that integrates Islamic values with modern knowledge to nurture well-rounded individuals.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Providing high-quality education following both traditional and modern methodologies.",
                icon: (
              ...
              },
              {
                ...
                description: "Focusing on moral values, ethics, and character development alongside academic excellence.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-10 sm:w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              },
              {
                ...
                description: "Encouraging students to engage in community service and contribute to society's betterment.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-10 sm:w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="bg-gray-100 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-black">Join Our Community</h2>
            <p className="mt-3 sm:mt-4 text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
              Become a part of our community and contribute to our mission of providing quality education.
            </p>
            <div className="mt-6 sm:mt-8">
              <Button className="bg-gradient-to-r from-blue-600 to-blue-800 text-white hover:from-blue-700 hover:to-blue-900 transition-colors border-2 border-blue-400 rounded-xl shadow-lg px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-medium">
                Contact Us Today
              </Button>
            </div>
          </motion.div>
