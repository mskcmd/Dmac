  ...
  const departments = [
    {
      name: "College of Islamic Da'wa",
      description:
        "The Dawah department focuses on outreach and community engagement, spreading knowledge and values through meaningful initiatives.",
      image: collgeoldimage1,
    },
    {
      name: "College of Islamic Shareeh",
      description:
        "Shareeh department provides in-depth education on Islamic law and principles, fostering a deep understanding of Sharia practices.",
      image: oldmasjidImage,
    },
    {
      name: "Thahfeezul Da'wa",
  ...
  const leadership = [
    {
      ...
      role: "Principal",
      image:
        "https://res.cloudinary.com/dkj7godal/image/upload/v1742915192/DMAC/m6hrbgazrsbky75r9zds.jpg",
      description:
        "Leading with vision and dedication, Abdul Kadir Baqavi Oorakam guides our institution with wisdom and commitment to excellence.",
    },
    {
      ...
      role: "Director",
      image:
        "https://res.cloudinary.com/dkj7godal/image/upload/v1742915192/DMAC/m0ajp3uyunjf1poj5cnu.jpg",
      description:
        "Ibrahim Saqafi Puzhakatteri oversees our mission, ensuring that our goals align with the values of education and community service.",
    },
    {
      ...
      role: "Usthad",
      image:
        "https://tse3.mm.bing.net/th?id=OIP.QQ_VCEvVW66x7PSZJEJQgAHaHa&pid=Api&P=0&h=180",
      description:
        "A mentor and scholar, Abdurraheem Kidanzhi inspires students with his deep knowledge and passion for Islamic teachings.",
    },
  ];
